...
from aiter import build_tree_kernel as aiter_build_tree_kernel
from aiter import (
    build_tree_kernel_efficient as aiter_build_tree_kernel_efficient,
)
...
def build_tree_kernel_efficient(
    ...
    # TODO: make them torch.empty and fuse them into `aiter_build_tree_kernel`
    ...
    aiter_build_tree_kernel_efficient(
        parent_list,
        top_scores_index,
